...
export function TopBar() {
  return (
    <div className="bg-[#1A120B] text-amber-100/80 text-xs py-2 px-4 border-b border-amber-900/30">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
        {/* Left: Social Icons */}
        <div className="flex items-center space-x-4">
          <span className="text-amber-200/60 font-medium hidden sm:inline">Follow DodoDoggy:</span>
          ...
          <a href="#youtube" className="hover:text-amber-400 transition-colors" aria-label="YouTube">
        ...
        <div className="flex items-center gap-2 font-medium">
          ...
          <span>🇮🇳 12 Indian cities · <strong className="text-white">3,457 verified listings</strong></span>
        </div>
      </div>
    </div>
  );
